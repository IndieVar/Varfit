        ...
        <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl text-center">
                    <p id={'reviews'} className="text-base/7 font-semibold text-indigo-600">Отзывы</p>
                    <h5 className="mt-2 text-balance text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
